...
public sealed class SetOfferSellerSkuCommandHandler : IRequestHandler<SetOfferSellerSkuCommand, Result>
{
    ...
    public SetOfferSellerSkuCommandHandler(
    ...
    public async Task<Result> Handle(SetOfferSellerSkuCommand request, CancellationToken ct)
    {
        ...
        var res = offer.SetSellerSku(request.SellerSku);
