...
public sealed class DecreaseOfferStockCommandHandler : IRequestHandler<DecreaseOfferStockCommand, Result>
{
    ...
    public DecreaseOfferStockCommandHandler(
    ...
    public async Task<Result> Handle(DecreaseOfferStockCommand request, CancellationToken ct)
    {
        ...
        var res = offer.DecreaseStock(request.Amount);
