...
public sealed class IncreaseOfferStockCommandHandler : IRequestHandler<IncreaseOfferStockCommand, Result>
{
    ...
    public IncreaseOfferStockCommandHandler(
    ...
    public async Task<Result> Handle(IncreaseOfferStockCommand request, CancellationToken ct)
    {
        ...
        var res = offer.IncreaseStock(request.Amount);
