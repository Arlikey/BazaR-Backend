...
public sealed class ArchiveOfferCommandHandler : IRequestHandler<ArchiveOfferCommand, Result>
{
    ...
    public ArchiveOfferCommandHandler(
    ...
    public async Task<Result> Handle(ArchiveOfferCommand request, CancellationToken ct)
    {
