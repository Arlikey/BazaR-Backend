...
public sealed class ResumeOfferCommandHandler : IRequestHandler<ResumeOfferCommand, Result>
{
    ...
    public ResumeOfferCommandHandler(
    ...
    public async Task<Result> Handle(ResumeOfferCommand request, CancellationToken ct)
    {
