...
public sealed class PauseOfferCommandHandler : IRequestHandler<PauseOfferCommand, Result>
{
    ...
    public PauseOfferCommandHandler(
    ...
    public async Task<Result> Handle(PauseOfferCommand request, CancellationToken ct)
    {
