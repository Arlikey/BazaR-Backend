...
public sealed class MarkShippingReturnedCommandHandler
    : IRequestHandler<MarkShippingReturnedCommand, Result>
{
    ...
    public MarkShippingReturnedCommandHandler(
    ...
    public async Task<Result> Handle(MarkShippingReturnedCommand request, CancellationToken ct)
    {
        ...
        var result = shipping.MarkReturned();
        if (result.IsFailure)
            return result;
