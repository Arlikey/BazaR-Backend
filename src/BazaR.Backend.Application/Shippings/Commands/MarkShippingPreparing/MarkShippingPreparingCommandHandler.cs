...
public sealed class MarkShippingPreparingCommandHandler
    : IRequestHandler<MarkShippingPreparingCommand, Result>
{
    ...
    public MarkShippingPreparingCommandHandler(
    ...
    public async Task<Result> Handle(MarkShippingPreparingCommand request, CancellationToken ct)
    {
        ...
        var result = shipping.MarkPreparing();
        if (result.IsFailure)
            return result;
