...
public sealed class ShipShippingCommandHandler
    : IRequestHandler<ShipShippingCommand, Result>
{
    ...
    public ShipShippingCommandHandler(
    ...
    public async Task<Result> Handle(ShipShippingCommand request, CancellationToken ct)
    {
        ...
        var shippingResult = shipping.Ship(
            request.Carrier,
