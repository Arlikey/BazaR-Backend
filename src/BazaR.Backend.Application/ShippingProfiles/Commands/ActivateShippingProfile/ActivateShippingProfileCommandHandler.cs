...
public sealed class ActivateShippingProfileCommandHandler
    : IRequestHandler<ActivateShippingProfileCommand, Result>
{
    ...
    public ActivateShippingProfileCommandHandler(
    ...
    public async Task<Result> Handle(ActivateShippingProfileCommand request, CancellationToken ct)
    {
