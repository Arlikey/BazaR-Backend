...
public sealed class ArchiveShippingProfileCommandHandler
    : IRequestHandler<ArchiveShippingProfileCommand, Result>
{
    ...
    public ArchiveShippingProfileCommandHandler(
    ...
    public async Task<Result> Handle(ArchiveShippingProfileCommand request, CancellationToken ct)
    {
