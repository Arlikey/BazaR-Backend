...
public sealed class SuspendShippingProfileCommandHandler
    : IRequestHandler<SuspendShippingProfileCommand, Result>
{
    ...
    public SuspendShippingProfileCommandHandler(
    ...
    public async Task<Result> Handle(SuspendShippingProfileCommand request, CancellationToken ct)
    {
