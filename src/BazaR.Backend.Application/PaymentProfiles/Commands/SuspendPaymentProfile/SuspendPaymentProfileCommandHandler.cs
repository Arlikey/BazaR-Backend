...
public sealed class SuspendPaymentProfileCommandHandler
    : IRequestHandler<SuspendPaymentProfileCommand, Result>
{
    ...
    public SuspendPaymentProfileCommandHandler(
    ...
    public async Task<Result> Handle(SuspendPaymentProfileCommand request, CancellationToken ct)
    {
