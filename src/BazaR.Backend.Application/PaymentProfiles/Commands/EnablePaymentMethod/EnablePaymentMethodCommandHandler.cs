...
public sealed class EnablePaymentMethodCommandHandler
    : IRequestHandler<EnablePaymentMethodCommand, Result>
{
    ...
    public EnablePaymentMethodCommandHandler(
    ...
    public async Task<Result> Handle(EnablePaymentMethodCommand request, CancellationToken ct)
    {
