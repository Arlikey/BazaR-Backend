...
public sealed class ArchivePaymentProfileCommandHandler
    : IRequestHandler<ArchivePaymentProfileCommand, Result>
{
    ...
    public ArchivePaymentProfileCommandHandler(
    ...
    public async Task<Result> Handle(ArchivePaymentProfileCommand request, CancellationToken ct)
    {
