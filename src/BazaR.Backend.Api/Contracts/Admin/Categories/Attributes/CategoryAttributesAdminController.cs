using BazaR.Backend.Api.Contracts.Admin.Catalog.Categories.Attributes;
...
public sealed class CategoryAttributesAdminController : ControllerBase
{
    private readonly IMediator _mediator;

    public CategoryAttributesAdminController(IMediator mediator)
    {
        _mediator = mediator;
    }
