...
namespace BazaR.Backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260227142735_InitialCreate10")]
                    ...
                    b.OwnsMany("CartItem", "_items", b1 =>
                        {
                            ...
                            b1.OwnsOne("BazaR.Backend.Domain.Carts.MoneySnapshot", "PriceSnapshot", b2 =>
                                {
