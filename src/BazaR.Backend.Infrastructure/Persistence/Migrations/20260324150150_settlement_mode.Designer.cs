...
namespace BazaR.Backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260324150150_settlement_mode")]
    partial class settlement_mode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BazaR.Backend.Domain.Shippings.Shipping", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ArrivedAtPickupPointAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset?>("ExternalStatusUpdatedAtUtc")
                        .HasColumnType("timestamp with time zone");
                            ...
                            b1.OwnsOne("BazaR.Backend.Domain.Checkouts.ShippingSelection", "Shipping", b2 =>
                                {
                                    ...
                                    b2.Property<string>("NovaPostRecipientDivisionId")
                                        .HasMaxLength(100)
                                        .HasColumnType("character varying(100)")
                                        .HasColumnName("shipping_nova_post_recipient_division_id");

                                    b2.Property<string>("NovaPostRecipientDivisionName")
                                        .HasMaxLength(200)
                                        .HasColumnType("character varying(200)")
                                        .HasColumnName("shipping_nova_post_recipient_division_name");
                    ...
                    b.OwnsOne("BazaR.Backend.Domain.Shippings.ShippingDestination", "Destination", b1 =>
                        {
                            ...
                            b1.Property<string>("NovaPostRecipientDivisionId")
                                .HasMaxLength(100)
                                .HasColumnType("character varying(100)")
                                .HasColumnName("destination_nova_post_recipient_division_id");

                            b1.Property<string>("NovaPostRecipientDivisionName")
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("destination_nova_post_recipient_division_name");
                    ...
                    b.OwnsMany("BazaR.Backend.Domain.Shippings.ShippingParcel", "Parcels", b1 =>
                        {
                            ...
                            b1.HasIndex("ShippingId", "RowNumber")
                                .IsUnique()
                                .HasDatabaseName("ux_shipping_parcels_shipping_id_row_number");
                    ...
                    b.OwnsOne("BazaR.Backend.Domain.Shippings.ShippingSender", "Sender", b1 =>
                        {
                            ...
                            b1.Property<string>("NovaPostDivisionId")
                                .HasMaxLength(100)
                                .HasColumnType("character varying(100)")
                                .HasColumnName("sender_nova_post_division_id");

                            b1.Property<string>("NovaPostDivisionName")
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("sender_nova_post_division_name");
